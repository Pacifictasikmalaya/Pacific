...
class Model_pelanggan extends CI_Model{
  ...
  public function getrecordPelanggan($cabang = "", $salesman="",$namapel="",$dari="",$sampai="") {
  ...
  public function getdataPelanggan($rowno,$rowperpage,$cabang="",$salesman="",$namapel="",$dari="",$sampai="") {
    $this->db->select('kode_pelanggan,nama_pelanggan,alamat_pelanggan,pelanggan.no_hp,pasar,hari,nama_cabang,nama_karyawan,latitude,longitude,time_stamps,jatuhtempo,foto');
    $this->db->from('pelanggan');
    $this->db->join('cabang','pelanggan.kode_cabang = cabang.kode_cabang');
    $this->db->join('karyawan','pelanggan.id_sales = karyawan.id_karyawan');
    $this->db->where('nama_pelanggan !=','BATAL');
