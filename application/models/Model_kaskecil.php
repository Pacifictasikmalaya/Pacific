...
class Model_kaskecil extends CI_Model{
  ...
  public function getData($rowno,$rowperpage,$dari="",$sampai="",$nobukti="",$kodeakun="") {
   ...
   $this->db->select('id,nobukti,tgl_kaskecil,kaskecil_detail.keterangan,jumlah,kaskecil_detail.kode_akun,status_dk,nama_akun,kaskecil_detail.kode_klaim,klaim.keterangan as ket_klaim,no_ref');
...
public function getDataKlaim($rowno,$rowperpage,$dari="",$sampai="") {
  $cabang = $this->session->userdata('cabang');
  if($cabang=="pusat"){
    $cabang = 'PST';
  }else{
...
public function getDataKlaimcabang($rowno,$rowperpage,$dari="",$sampai="",$cabang="") {
  if($cabang != ""){
    $this->db->where('kode_cabang',$cabang);
  }
...
public function getDataMB($rowno,$rowperpage,$dari="",$sampai="") {
  $cabang = $this->session->userdata('cabang');
  if($cabang=="pusat"){
    $cabang = 'PST';
  }else{
...
function insert_klaim(){
  ...
  if($simpan){
    ...
    $this->session->set_flashdata('msg',
      ...
      <i class="material-icons" style="float:left; margin-right:10px">check</i> Data Berhasil Disiman !
...
function insert_ledger(){
  ...
  if(empty($cek)){
    ...
    $this->session->set_flashdata('msg',
      ...
      <i class="material-icons" style="float:left; margin-right:10px">check</i> Data Sudah Diinputkan sebelumnya !
...
function batal_klaim($kode_klaim){
  ...
  if($hapus){
    ...
    $this->session->set_flashdata('msg',
      ...
      <i class="material-icons" style="float:left; margin-right:10px">check</i> Data Klaim Berhasil Dibatalkan !
...
function batalkan_validasi($no_bukti){
  ...
  if($hapus_kaskecil){
    ...
    $this->session->set_flashdata('msg',
      ...
      <i class="material-icons" style="float:left; margin-right:10px">check</i> Data Validasi Berhasil Dibatalkan !
