  ...
  function cek_detailtmpfsthp(){
	...
	function insert_fsthp(){
      ...
      '<div class="alert bg-red alert-dismissible" role="alert">
          ...
          <i class="material-icons" style="float:left; margin-right:10px">check</i> No FSTHP Sudah Digunakan !
        </div>');
    	...
    	if($hapus) {
	        ...
	        '<div class="alert bg-green alert-dismissible" role="alert">
	              ...
	              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	                 ...
	                 <i class="material-icons" style="float:left; margin-right:10px">check</i> Data Berhasil Hapus !
