...
class Model_oman extends CI_Model{
	...
	function view_oman($no_order=null){
		if($no_order !=null){
	...
	function view_permintaanproduksi(){
		return $this->db->get('permintaan_produksi');
	}
	...
	function approve_permintaan($no_permintaan,$no_oman){
        ...
        '<div class="alert bg-green alert-dismissible" role="alert">
          <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <i class="material-icons" style="float:left; margin-right:10px">check</i> Data Berhasil Di Approve !
        </div>');
