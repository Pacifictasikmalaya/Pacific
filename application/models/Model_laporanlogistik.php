...
class Model_laporanlogistik extends CI_Model{
  ...
  function getKategori(){
    ...
    if ($kodedept != "") {
      ...
      $kodedept = "AND kategori_barang_pembelian.kode_dept = '".$kodedept."' ";
  ...
  function list_detailPemasukan($dari,$sampai,$kode_kategori,$kode_barang){
    ...
    $query = "
    SELECT gk.nama_supplier,pemasukan.tgl_pemasukan,master_barang_pembelian.kode_barang,satuan,keterangan,nama_barang,kategori,nama_akun,coa.kode_akun,harga,qty,pemasukan.nobukti_pemasukan FROM detail_pemasukan
