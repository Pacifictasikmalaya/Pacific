...
class Model_laporangudangjadi extends CI_Model{
	...
	function rekapmutasi($dari,$sampai){
		...
		$query = "SELECT
					...
					(
						SELECT
							SUM(IF(jenis_mutasi = 'FSTHP',jumlah,0))
						FROM
							detail_mutasi_gudang d
						INNER JOIN mutasi_gudang_jadi
						ON d.no_mutasi_gudang = mutasi_gudang_jadi.no_mutasi_gudang
						WHERE d.kode_produk = m.kode_produk AND
						tgl_mutasi_gudang BETWEEN '$dari' AND '$sampai'
					) as jmlfsthp,
					(
						SELECT
							SUM(IF(jenis_mutasi = 'SURAT JALAN',jumlah,0))
						FROM
							detail_mutasi_gudang d
						INNER JOIN mutasi_gudang_jadi
						ON d.no_mutasi_gudang = mutasi_gudang_jadi.no_mutasi_gudang
					...
					(
						SELECT
							SUM(IF(jenis_mutasi = 'REPACK',jumlah,0))
						FROM
							detail_mutasi_gudang d
						INNER JOIN mutasi_gudang_jadi
						ON d.no_mutasi_gudang = mutasi_gudang_jadi.no_mutasi_gudang
					...
					(
						SELECT
							SUM(IF(jenis_mutasi = 'REJECT',jumlah,0))
						FROM
							detail_mutasi_gudang d
						INNER JOIN mutasi_gudang_jadi
						ON d.no_mutasi_gudang = mutasi_gudang_jadi.no_mutasi_gudang
