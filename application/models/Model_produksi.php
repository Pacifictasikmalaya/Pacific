...
class Model_produksi extends CI_Model{
  ...
  function getdetailsaldo($bulan,$tahun){
    ...
    WHERE master_barang_produksi.kode_dept = 'PRD' AND master_barang_produksi.status = 'Aktif' 
    GROUP BY 
    master_barang_produksi.kode_barang,
    master_barang_produksi.nama_barang,
    gm.qtypemasukan,
  ...
  function getDetailopname($bulan,$tahun){
    ...
    LEFT JOIN (SELECT opname_gp_detail.kode_barang,SUM( qty ) AS qtyopname FROM opname_gp_detail 
