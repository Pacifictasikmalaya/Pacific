...
class Model_repackreject extends CI_Model{
  ...
  function insert_repack(){
    ...
    if($cek != 0){
     ...
     '<div class="alert bg-red alert-dismissible" role="alert">
        ...
        <i class="material-icons" style="float:left; margin-right:10px">check</i> No Repack Sudah Digunakan !
      </div>');
	...
	function update_penyesuaian()
  {
	...
	function hapuspenyesuaian($no_penyesuaian,$cabang,$hal){
    ...
    if(empty($ceksa)){
	    ...
	    if($delete){
	      ...
	      $this->session->set_flashdata('msg',
	    	...
	    	redirect('repackreject/penyesuaian/'.$hal);
	    }
		}else{
			$this->session->set_flashdata('msg',
				'<div class="alert bg-red alert-dismissible" role="alert">
  ...
  public function getrecordRJGCount($tanggal="",$cabang="")
  {
    ...
    $this->datatables->add_column('view', '<a href="#" data-nosj="$1"  class="btn bg-red btn-xs waves-effect pilihpel">Pilih</a>', 'no_mutasi_gudang_cabang');
