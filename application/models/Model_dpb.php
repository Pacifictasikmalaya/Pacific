...
class Model_dpb extends CI_Model
{
  ...
  function jsondpb(){
    ...
    $this->datatables->add_column('view', '<a href="#" data-nodpb="$1" data-idkaryawan="$7" data-tglpengambilan="$3" data-cabang="$2" data-salesman="$4" data-tujuan="$5" data-nokendaraan="$6"   class="btn bg-red btn-xs waves-effect pilihpel">Pilih</a>', 'no_dpb,kode_cabang,tgl_pengambilan,nama_karyawan,tujuan,no_kendaraan,id_karyawan');
