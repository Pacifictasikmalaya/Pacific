  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="body">
        ...
        <div class="row clearfix">
          <div class="col-sm-12">
            <a href="<?php echo base_url(); ?>gudangbahan/input_pemasukan" class="btn btn-danger">Tambah Data</a>
            <hr>
                  ...
                  foreach ($result as $d){
                    ...
                    <tr>
                      ...
                      <td >
                        ...
                        <a href="#" data-href="<?php echo base_url(); ?>gudangbahan/hapuspemasukan/<?php echo $nobukti; ?>" class="btn btn-xs btn-danger hapus">Hapus</a>
                        <a href="<?php echo base_url(); ?>gudangbahan/edit_pemasukan/<?php echo $nobukti; ?>" class="btn btn-xs btn-warning">Edit</a>
                      </td>
                    </tr>
                    <?php
                    $no++;
