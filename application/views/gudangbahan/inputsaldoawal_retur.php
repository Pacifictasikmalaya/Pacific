  ...
  <div class="col-md-8">
    <div class="card">
     ...
     <div class="body">
      <div class="row">
        <div class="col-md-12">
          <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>gudangbahan/input_saldoawal_retur">
  ...
  $(function(){
    ...
    function loaddetailsaldo()
    {
      ...
      if(bulan == ""){
        ...
        $.ajax({
          type    : 'POST',
          url     : '<?php echo base_url(); ?>gudangbahan/getdetailsaldoretur',
