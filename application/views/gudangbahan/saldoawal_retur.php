  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="body">
        ...
        <div class="row clearfix">
          <div class="col-sm-12">
            <a href="<?php echo base_url(); ?>gudangbahan/inputsaldoawal_retur" class="btn btn-danger">Tambah Data</a>
            <hr>
                  ...
                  foreach ($result as $d){
                    ...
                    <tr>
                      ...
                      <td width="10px">
                        ...
                        <a href="#" data-href="<?php echo base_url(); ?>gudangbahan/hapussaldoawal_retur/<?php echo $kode_saldoawal_gb; ?>" class="btn btn-xs btn-danger hapus">Hapus</a>
                      </td>
                    </tr>
                    <?php
                    $no++;
