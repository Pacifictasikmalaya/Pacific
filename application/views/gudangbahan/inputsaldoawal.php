  ...
  <div class="col-md-8">
    <div class="card">
     ...
     <div class="body">
      <div class="row">
        <div class="col-md-12">
          <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>gudangbahan/input_saldoawal">
...
<!--             <div class="form-group" >
              <div class="form-line">
                <select class="form-control" id="kategori" name="kategori">
                  ...
                  <option value="K010">Bahan Baku</option>
                  <option value="K009">Bahan Kemasan</option>
                </select>
              </div>
            </div> -->
            <div class="input-group demo-masked-input"  >
  ...
  $(function(){
    ...
    function loaddetailsaldo()
    {
      ...
      if(bulan == ""){
        ...
        $.ajax({
          type    : 'POST',
          url     : '<?php echo base_url(); ?>gudangbahan/getdetailsaldo',
