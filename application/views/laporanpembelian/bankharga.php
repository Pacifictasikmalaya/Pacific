  ...
  <div class="col-md-6">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
          Laporan Bank Harga
          <small>Laporan Bank Harga </small>
        </h2>
      </div>
      <div class="body">
        <div class="row clearfix">
          <div class="col-sm-12">
            <form class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporanpembelian/cetak_bankharga" target="_blank">
              <div class="col-sm-6">
              ...
              <div class="form-group" >
                <div class="form-line">
                  <select class="form-control show-tick" id="barang" name="barang" data-error=".errorTxt1" data-live-search="true">
                    <option value="">--Barang--</option>
                    <?php foreach($barang as $d){ ?>
                      <option value="<?php echo $d->kode_barang; ?>"><?php echo $d->nama_barang; ?></option>
                    <?php }  ?>
                  </select>
                </div>
              </div>
