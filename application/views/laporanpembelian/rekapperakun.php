  ...
  <div class="col-md-6">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
          Rekap Pembelian Per-Akun
          <small>Rekap Pembelian Per-Akun</small>
        </h2>
      </div>
      <div class="body">
        <div class="row clearfix">
          <div class="col-sm-12">
            <form class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporanpembelian/cetak_rekapperakun" target="_blank">
              <div class="col-sm-6">
