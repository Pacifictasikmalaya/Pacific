...
<table class="datatable3" style="width:100%" border="1">
  <thead>
    <tr>
      ...
      <th bgcolor="#024a75" style="color:white; font-size:12;">Akun</th>
  ...
  <tbody>
    ...
    ?>
    <tr>
      <th bgcolor="#024a75" style="color:white; font-size:12;" colspan="9" align="center">Total</th>
      <th bgcolor="#024a75" style="color:white; font-size:12;" align="right"><?php echo number_format($total); ?></th>
      <th bgcolor="#024a75" style="color:white; font-size:12;" align="right"><?php echo number_format($totalkredit); ?></th>
      <th bgcolor="#024a75" style="color:white; font-size:12;" align="right"><?php echo number_format($totaldebet); ?></th>
    </tr>
  </tbody>
</table>
