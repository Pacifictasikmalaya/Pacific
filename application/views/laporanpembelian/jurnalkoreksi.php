  ...
  <div class="col-md-6">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
          Laporan Jurnal Koreksi
          <small>Laporan Jurnal Koreksi </small>
        </h2>
      </div>
      <div class="body">
        <div class="row clearfix">
          <div class="col-sm-12">
            <form class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporanpembelian/cetak_jurnalkoreksi" target="_blank">
              <div class="col-sm-6">
