    ...
    <div class="card">
      <div class="header bg-cyan">
        <h2>
          ...
          <small>Update Penyesuaian Bad Stok</small>
        </h2>
      </div>
      <div class="body">
        <div class="row">
          <div class="col-md-12">
            <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>repackreject/update_penyesuaianbad">
              ...
              <div class="demo-radio-button">
                ...
                <input name="inout" <?php if($mutasi['inout_bad']=="IN"){echo "checked";} ?> type="radio" value="IN" id="radio_1" class="inout"  />
                <label for="radio_1">IN</label>
                <input name="inout" <?php if($mutasi['inout_bad']=="OUT"){echo "checked";} ?> type="radio" value="OUT" id="radio_2" class="inout" />
