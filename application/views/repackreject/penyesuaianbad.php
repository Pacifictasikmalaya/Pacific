  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="body">
        ...
        <div class="row clearfix">
          <div class="col-sm-12">
            <a href="<?php echo base_url();?>repackreject/inputpenyesuaianbad" class="btn btn-danger">Tambah Data</a>
            <hr>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><span class="badge <?php if($d['inout_bad']=='IN'){echo 'bg-green';}else{echo 'bg-red';} ?>"><?php echo $d['inout_bad']; ?></span></td>
                      <td>
                        <a href="#" class="btn btn-xs btn-info detail" data-nomutasi="<?php echo $d['no_mutasi_gudang_cabang']; ?>">Detail</a>
                        <a href="<?php echo base_url(); ?>repackreject/updatepenyesuaianbad/<?php echo $d['no_mutasi_gudang_cabang']; ?>" class="btn btn-xs bg-blue">Update</a>
                        <a data-href="<?php echo base_url(); ?>repackreject/hapuspenyesuaianbad/<?php echo $d['no_mutasi_gudang_cabang']; ?>/<?php echo $d['kode_cabang']; ?>" class="btn btn-xs btn-danger hapus">Hapus</a>
                      </td>
                    </tr>
                    <?php
                      $sno++;
