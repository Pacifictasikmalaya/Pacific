  ...
  <div class="col-md-12">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
          DATA PENYESUAIAN GOOD STOK
          <small>DATA PENYESUAIAN GOOD STOK</small>
        </h2>
      </div>
      <div class="body">
        <div class="row">
        ...
        <div class="row clearfix">
          <div class="col-sm-12">
            <a href="<?php echo base_url();?>repackreject/inputpenyesuaian" class="btn btn-danger">Tambah Data</a>
            <hr>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><span class="badge <?php if($d['inout_good']=='IN'){echo 'bg-green';}else{echo 'bg-red';} ?>"><?php echo $d['inout_good']; ?></span></td>
                      <td>
                        <a href="#" class="btn btn-xs btn-info detail" data-nomutasi="<?php echo $d['no_mutasi_gudang_cabang']; ?>">Detail</a>
                        <a href="<?php echo base_url(); ?>repackreject/updatepenyesuaian/<?php echo $d['no_mutasi_gudang_cabang']; ?>" class="btn btn-xs bg-blue">Update</a>
                        <a data-href="<?php echo base_url(); ?>repackreject/hapuspenyesuaian/<?php echo $d['no_mutasi_gudang_cabang']; ?>" class="btn btn-xs btn-danger hapus">Hapus</a>
                      </td>
                    </tr>
                    <?php
                      $sno++;
    ...
    <div class="modal-content">
      <div class="card">
        <div class="header bg-cyan">
          <h2>
            DATA PENYESUAIAN GOOD STOK
            <small>Data Penyesuaian Bad Stok</small>
          </h2>
        </div>
        <div class="body">
          <div class="row clearfix">
