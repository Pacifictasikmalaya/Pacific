  ...
  <div class="col-md-8">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
           UPDATE PENYESUAIAN GOOD STOK
          <small>Update Penyesuaian Good Stok</small>
        </h2>
      </div>
      <div class="body">
        <div class="row">
          <div class="col-md-12">
            <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>repackreject/update_penyesuaian">
              ...
              <div class="demo-radio-button">
                <input name="inout" <?php if($mutasi['inout_good']=="IN"){echo "checked";} ?> type="radio" value="IN" id="radio_1" class="inout"  />
                <label for="radio_1">IN</label>
                <input name="inout" <?php if($mutasi['inout_good']=="OUT"){echo "checked";} ?> type="radio" value="OUT" id="radio_2" class="inout" />
