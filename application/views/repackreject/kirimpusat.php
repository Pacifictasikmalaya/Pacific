  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="body">
        ...
        <div class="row clearfix">
          <div class="col-sm-12">
            <a href="<?php echo base_url();?>repackreject/inputkirimpusat" class="btn btn-danger">Tambah Data</a>
            <hr>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo base_url(); ?>repackreject/updatekirimpusat/<?php echo $d['no_mutasi_gudang_cabang']; ?>" class="btn btn-xs bg-blue">Update</a>
                        <a data-href="<?php echo base_url(); ?>repackreject/hapuskirimpusat/<?php echo $d['no_mutasi_gudang_cabang']; ?>/<?php echo $d['kode_cabang']; ?>" class="btn btn-xs btn-danger hapus">Hapus</a>
                      </td>
                    </tr>
                    <?php
                      $sno++;
