        ...
        <div class="row">
          <form action="<?php echo base_url(); ?>komisi/targetkomisi" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="submit" name="submit" class="btn bg-blue m-2-15 waves-effect" value="SET TARGET">
              </div>  
            </div>
                    ...
                    <tr>
                      ...
                      <td style="width:20%">
                        <div class="form-group"  >
                          <div class="col-sm-12" style="margin-bottom:2px !important">
                            <div class="form-line">
                              <input type="text" kode-kriteria="K001" data-nik="<?php echo $d->nik; ?>" value="<?php echo $d->target_kuantitas; ?>" id="kuantitas" name="kuantitas"  
                              class="form-control kuantitas" placeholder="" data-error=".errorTxt11">
                            </div>
                          </div>
                        </div>
                      </td>
                      <td style="width:20%">
                        <div class="form-group"  >
                          <div class="col-sm-12" style="margin-bottom:2px !important">
                            <div class="form-line">
                              <input type="text" kode-kriteria="K002" data-nik="<?php echo $d->nik; ?>" value="<?php echo $d->target_cashin; ?>" id="cashin" name="cashin"  
                              class="form-control cashin" placeholder="" data-error=".errorTxt11">
                            </div>
                          </div>
                        </div>
                      </td>
                      <td style="width:20%">
                        <div class="form-group"  >
                          <div class="col-sm-12" style="margin-bottom:2px !important">
                            <div class="form-line">
                              <input type="text" kode-kriteria="K003" data-nik="<?php echo $d->nik; ?>" value="<?php echo $d->target_collection; ?>" id="collection" name="collection"  
                              class="form-control collection" placeholder="" data-error=".errorTxt11">
                            </div>
                          </div>
                        </div>
                      </td>
  ...
  $(function(){
    ...
    $(".kuantitas").on('keyup keydown change',function(){
      ...
      var jmltarget = $(this).val();
        ...
        data : {nik:nik,bulan:bulan,tahun:tahun,jmltarget:jmltarget,kodekriteria:kodekriteria},
        cache : false,
