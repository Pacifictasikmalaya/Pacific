<div class="card">
  <div class="header bg-cyan">
    <h2>
      Edit Penerima Komisi
      <small>Edit Penerima Komisi</small>
    </h2>
  </div>
  <div class="body">
          ...
          <div class="form-group">
            ...
            <div class="form-line">
              <select disabled class="form-control show-tick" id="cabanginput" name="cabanginput" data-error=".errorTxt1">
                ...
                <option <?php if($c->kode_cabang == $penerima['kode_cabang']){echo "selected";} ?> value="<?php echo $c->kode_cabang; ?>"><?php echo strtoupper($c->nama_cabang); ?></option>
                <?php } ?>
              </select>
            </div>
          ...
          <div class="form-group">
            <div class="form-line">
              <select class="form-control show-tick" id="jabataninput" name="jabatan">
                ...
                <option <?php if($d->kode_jabatan == $penerima['kode_jabatan']){echo "selected";} ?>  value="<?php echo $d->kode_jabatan; ?>"><?php echo strtoupper($d->nama_jabatan); ?></option>
                <?php } ?>
              </select>
            </div>
          </div>
            ...
            <div class="form-line">
              <select class="form-control show-tick" id="salesman" name="salesman">
                ...
                <?php foreach($sales as $d){ ?>
                  <option <?php if($d->id_karyawan == $penerima['id_sales']){echo "selected";} ?> value="<?php echo $d->id_karyawan; ?>"><?php echo strtoupper( $d->id_karyawan." | ".$d->nama_karyawan); ?></option>
                <?php } ?>
              </select>
            </div>
          </div>
