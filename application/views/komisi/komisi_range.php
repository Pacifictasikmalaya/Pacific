  ...
  <div class="col-md-12">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
          Data Range Komisi
          <small>List Data Range Komisi</small>
        </h2>
      </div>
      <div class="body">
        <div class="row">
          <form action="<?php echo base_url(); ?>komisi/rangekomisi" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="submit" name="submit" class="btn bg-blue m-2-15 waves-effect" value="SET RANGE">
              </div>  
            </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr style="text-align:center">
                      ...
                      <td><?php echo $rg[1]; ?></td>
                      <td>
                        <div class="form-group divkacab">
                          <div class="col-sm-12" style="margin-bottom:2px !important">
                            <div class="form-line">
                              <input type="text" dari="<?php echo $rg[0]; ?>" sampai="<?php echo $rg[1]; ?>" 
                              kacab = "<?php echo $dr['kacab'] ?>"
                              spv = "<?php echo $dr['spv'] ?>"
                              sales = "<?php echo $dr['sales'] ?>"
                              driverhelper = "<?php echo $dr['driverhelper'] ?>"
                              kepalagudang = "<?php echo $dr['kepalagudang'] ?>"
                              gudang = "<?php echo $dr['gudang'] ?>"
                              id="kacab" name="kacab"  
                              class="form-control kacab" maxlength="5" value="<?php echo $dr['kacab']; ?>" placeholder="" data-error=".errorTxt11">
                            </div>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="form-group divspv"  >
                          <div class="col-sm-12" style="margin-bottom:2px !important">
                            <div class="form-line">
                              <input type="text" value="<?php echo $dr['spv']; ?>" dari="<?php echo $rg[0]; ?>" sampai="<?php echo $rg[1]; ?>" 
                              kacab = "<?php echo $dr['kacab'] ?>"
                              spv = "<?php echo $dr['spv'] ?>"
                              sales = "<?php echo $dr['sales'] ?>"
                              driverhelper = "<?php echo $dr['driverhelper'] ?>"
                              ...
                              gudang = "<?php echo $dr['gudang'] ?>"
                              id="spv" name="spv"  
                              class="form-control spv" maxlength="5" placeholder="" data-error=".errorTxt11">
                            </div>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="form-group divsales"  >
                          <div class="col-sm-12" style="margin-bottom:2px !important">
                            <div class="form-line">
                              <input type="text" dari="<?php echo $rg[0]; ?>" sampai="<?php echo $rg[1]; ?>" 
                              kacab = "<?php echo $dr['kacab'] ?>"
                              ...
                              gudang = "<?php echo $dr['gudang'] ?>"
                              id="sales" name="sales"  
                              class="form-control sales" maxlength="5" value="<?php echo $dr['sales']; ?>" placeholder="" data-error=".errorTxt11">
                            </div>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="form-group divdriverhelper"  >
                          <div class="col-sm-12" style="margin-bottom:2px !important">
                            <div class="form-line">
                              <input type="text" dari="<?php echo $rg[0]; ?>" sampai="<?php echo $rg[1]; ?>" 
                              kacab = "<?php echo $dr['kacab'] ?>"
                              ...
                              kepalagudang = "<?php echo $dr['kepalagudang'] ?>"
                              gudang = "<?php echo $dr['gudang'] ?>"
                              id="driverhelper" name="driverhelper"  
                              class="form-control driverhelper" maxlength="5" value="<?php echo $dr['driverhelper']; ?>" placeholder="" data-error=".errorTxt11">
                            </div>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="form-group divkepalagudang"  >
                          <div class="col-sm-12" style="margin-bottom:2px !important">
                            <div class="form-line">
                              <input type="text" dari="<?php echo $rg[0]; ?>" sampai="<?php echo $rg[1]; ?>" id="kepalagudang" name="kepalagudang"  
                              class="form-control kepalagudang" maxlength="5" value="<?php echo $dr['kepalagudang']; ?>" placeholder="" data-error=".errorTxt11">
                            </div>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="form-group divgudang"  >
                          <div class="col-sm-12" style="margin-bottom:2px !important">
                            <div class="form-line">
                              <input type="text" dari="<?php echo $rg[0]; ?>" sampai="<?php echo $rg[1]; ?>"  
                              kacab = "<?php echo $dr['kacab'] ?>"
                              ...
                              class="form-control gudang" maxlength="5" value="<?php echo $dr['gudang']; ?>" placeholder="" data-error=".errorTxt11">
                            </div>
                          </div>
                        </div>
                      </td>
