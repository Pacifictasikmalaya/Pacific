...
<html lang="en">
  ...
  <body class="antialiased">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item active dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li >
                      <a class="dropdown-item active" href="./layout-condensed-dark.html" >
                        Condensed dark
                      </a>
                    </li>
                    <li >
                ...
                <div class="table-responsive">
                  <table class="table card-table table-vcenter">
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <div class="chart-sparkline" id="sparkline-22"></div>
                      </td>
                    </tr>
                    <tr>
                      <td>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-19').text("56/100").peity("pie", {
      		width: 40,
      		height: 40,
      		stroke: "#cd201f",
      		strokeWidth: 2,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-20').text("22/100").peity("pie", {
      		width: 40,
      		height: 40,
      		stroke: "#fab005",
      		strokeWidth: 2,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-21').text("17, 24, 20, 10, 5, 1, 4, 18, 13").peity("line", {
      		width: 64,
      		height: 40,
      		stroke: "#206bc4",
      		strokeWidth: 2,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-22').text("13, 11, 19, 22, 12, 7, 14, 3, 21").peity("line", {
      		width: 64,
      		height: 40,
      		stroke: "#206bc4",
      		strokeWidth: 2,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-23').text("10, 13, 10, 4, 17, 3, 23, 22, 19").peity("line", {
      		width: 64,
      		height: 40,
      		stroke: "#206bc4",
      		strokeWidth: 2,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
      	$().peity && $('#sparkline-24').text("9, 6, 14, 11, 8, 24, 2, 16, 15").peity("line", {
      		width: 64,
      		height: 40,
      		stroke: "#206bc4",
      		strokeWidth: 2,
