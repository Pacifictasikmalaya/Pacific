...
<div class="card">
    ...
    <div class="body">
        <div class="row clearfix">
            <div class="col-sm-12">
                 <form autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>barang/input_barang">
                    ...
                    <div class="form-group" >
                        <div class="form-line">
                             <select class="form-control" id="kategori" name="kategori" data-error=".errorTxt3">
                                 ...
                                 <option <?php if ($getbrg['kategori']=="SWAN"){ echo "selected";} ?> value="SWAN">SWAN</option>
                                 <option <?php if ($getbrg['kategori']=="AIDA"){ echo "selected";} ?> value="AIDA">AIDA</option>
                             </select>
                        ...
                        <div class="form-line">
                            <select class="form-control" id="cabang" name="cabang" data-error=".errorTxt13">
                                ...
                                <?php foreach($cabang as $c){ ?>
                                    <option <?php if ($getbrg['kode_cabang']==$c->kode_cabang){ echo "selected";} ?>  value="<?php echo $c->kode_cabang; ?>"><?php echo strtoupper($c->nama_cabang); ?></option>
                                <?php } ?>
                            </select>
                        </div>
