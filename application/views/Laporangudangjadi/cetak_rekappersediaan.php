...
<table class="datatable3" style="width:80%" border="1">
	...
	<tbody>
		<?php
			...
			$saldoakhir 		= $m->saldoawal+($m->jmlfsthp + $m->jmlrepack) - ($m->jmlsuratjalan + $m->jmlreject);
		...
		?>
			<tr style="font-weight: bold; font-size:11px">
				...
				<td align="right"><?php if($m->jmlrepack !=0){echo uang($m->jmlrepack); } ?></td>
				<td align="right"><?php if($m->jmlsuratjalan !=0){echo uang($m->jmlsuratjalan); } ?></td>
				<td align="right"><?php if($m->jmlreject !=0){echo uang($m->jmlreject); } ?></td>
