    ...
    <div class="col-md-6">
        <div class="card">
            <div class="header bg-cyan">
                <h2>
                    Rekapitulasi Penerimaan Hasil Produksi
                    <small> Rekapitulasi Penerimaan Hasil Produksi  </small>
                </h2>
            </div>
            <div class="body">
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <form class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporangudangjadi/cetak_rekaphasilproduksi" target="_blank">
