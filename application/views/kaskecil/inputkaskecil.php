<div class="card">
  ...
  <div class="body">
    <div class="row clearfix">
      <div class="col-sm-12">
        <form autocomplete="off" class="formValidate" id="formValidate" method="POST"
          action="<?php echo base_url(); ?>kaskecil/insert_kaskecil">
          ...
          <div class="row">
            <div class="body">
              ...
              <div class="input-group demo-masked-input">
                ...
                <div class="form-line">
                  <input type="text" id="tanggal" name="tanggal" class="datepicker form-control date"
                    placeholder="Tanggal" data-error=".errorTxt1" />
              ...
              <div class="input-group demo-masked-input">
                ...
                <div class="form-line">
                  <input type="text" id="nobukti_input" name="nobukti" class="form-control" placeholder="No Bukti"
              ...
              <div class="input-group demo-masked-input">
                ...
                <div class="form-line">
                  <input type="text" id="penerima" name="penerima" class="form-control" placeholder="Diberikan Kepada"
                    data-error=".errorTxt2" />
                </div>
                <div class="errorTxt2"></div>
              </div>
            ...
            <div class="body">
              <div class="col-md-4">
                ...
                <div class="input-group">
                  <div class="form-line">
                    <input type="text" style="text-align:right" id="jumlah" name="jumlah" class="form-control"
                      placeholder="Jumlah" data-error=".errorTxt2" />
                  </div>
                </div>
              </div>
              <div class="col-md-6">
          ...
          <div class="row">
            <div class="body">
              <table class="table table-bordered table-striped table-hover">
                ...
                <tbody id="loaddetailkaskeciltemp">
                </tbody>
              </table>
            </div>
          </div>
