  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="body">
        ...
        <div class="row clearfix">
          <div class="col-sm-12">
            <a href="<?php echo base_url(); ?>produksi/input_pengeluaran" class="btn btn-danger">Tambah Data</a>
            <hr>
                  ...
                  foreach ($result as $d){
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="#" data-href="<?php echo base_url(); ?>produksi/hapuspengeluaran/<?php echo $nobukti; ?>" class="btn btn-xs btn-danger hapus">Hapus</a>
                        <a href="<?php echo base_url(); ?>produksi/edit_pengeluaran/<?php echo $nobukti; ?>" class="btn btn-xs btn-warning">Edit</a>
                      </td>
                    </tr>
                    <?php
                    $no++;
...
<script type="text/javascript">
  $(function(){
    ...
    $('.detail').click(function(e){
      ...
      $.ajax({
        type    : 'POST',
        url     : '<?php echo base_url(); ?>produksi/detail_pengeluaran',
