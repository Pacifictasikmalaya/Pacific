  ...
  <div class="col-md-8">
    <div class="card">
     ...
     <div class="body">
      <div class="row">
        <div class="col-md-12">
          <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>produksi/input_opname">
            <div class="input-group demo-masked-input"  >
              <span class="input-group-addon">
                <i class="material-icons">chrome_reader_mode</i>
              </span>
              <div class="form-line">
                <input type="text" readonly value="" id="kode_opname" name="kode_opname" class="form-control" placeholder="Kode opname Awal" data-error=".errorTxt19" />
  ...
  $(function(){
    ...
    function loaddetailopname()
    {
      ...
      if(bulan == ""){
        ...
        $.ajax({
          type    : 'POST',
          url     : '<?php echo base_url(); ?>produksi/getdetailopname',
