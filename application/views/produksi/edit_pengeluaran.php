<div class="card">
  ...
  <div class="body">
    <form autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>produksi/update_pengeluaran">
          ...
          <div class="form-group" >
            <div class="form-line">
              <select class="form-control show-tick" id="departemen" name="departemen" data-error=".errorTxt1">
                <option <?php if ($edit['kode_dept'] == "Pemakaian") { echo "selected"; }?> value="Pemakaian">Pemakaian</option>
                <option <?php if ($edit['kode_dept'] == "Retur Out") { echo "selected"; }?> value="Retur Out">Retur Out</option>
        ...
        <div class="body">
          ...
          <div class="col-md-2">
            <div class="input-group demo-masked-input"  >
              ...
              <div class="form-line">
                <input type="text" style="text-align:right" value="" id="qty" name="qty" class="form-control" placeholder="QTY" style="text-align:right" data-error=".errorTxt19" />
              </div>
            </div>
          </div>
          <div class="col-md-2">
...
<script>
  $(function(){
    ...
    function tampiltemp(){
      ...
      $.ajax({
        type    : 'POST',
        url     : '<?php echo base_url();?>produksi/view_detaileditpengeluaran',
        data    : 
        {
          nobukti : nobukti
        },
    ...
    $("#tambahbarang").click(function(e){
      ...
      if (kodebarang == 0) {
        ...
        $.ajax({
          type    : 'POST',
          url     : '<?php echo base_url();?>produksi/inputeditpengeluaran',
          data    :
          {
            nobukti         : nobukti,
