<form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>oman/edit_oman">
                        ...
                        <div class="col-sm-12">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" value="<?php echo $oman['tgl_order']; ?>"  id="tgl_order"  name="tgl_order" class="form-control datepicker"  data-error=".errorTxt4" placeholder="Tanggal Order" />
                                    ...
                                    <div class="form-line">
                                        <select class="form-control"  id="bulan" name="bulan" data-error=".errorTxt9">
                                            ...
                                            <?php 
                                             ...
                                             for($i=1; $i<=12; $i++){
                                             ?>
                                                <option <?php if($i==$oman['bulan']){echo "selected";} ?> value="<?php echo $i; ?>"><?php echo $bulan[$i]; ?></option>
                                             <?php
                                             }
                                    ...
                                    <div class="form-line">
                                        <select class="form-control" id="tahun" name="tahun" data-error=".errorTxt9">
                                            ...
                                            <?php 
                                             ...
                                             ?>
                                                <option <?php if($tahun==$oman['tahun']){echo "selected";} ?>  value="<?php echo $tahun; ?>"><?php echo $tahun ?></option>
                                             <?php
                                             }
