	...
	<div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <a href="<?php echo base_url(); ?>oman/input_oman" class="btn bg-red waves-effect" id="tambahpel"> Tambah Data </a>
                         <hr>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($o->status=='0'){ ?>
                                                    <a href="<?php echo base_url(); ?>oman/edit_oman/<?php echo $o->no_order; ?>" class="btn btn-xs bg-green">Edit</a>
                                                    <a href="#" class="btn btn-xs bg-red" data-target="#konfirmasi_hapus" data-toggle="modal" data-href="<?php echo base_url(); ?>oman/hapus/<?php echo $o->no_order;?>">Hapus</a>
