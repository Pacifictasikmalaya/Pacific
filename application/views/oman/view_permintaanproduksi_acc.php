                                            ...
                                            <td>
                                                <a href="#" data-noorder="<?php echo $p->no_order; ?>" class="btn btn-xs bg-teal detailpermintaan">Detail Permintaan</a>
                                                 <?php if($p->status==0 OR empty($p->status)){?>
                                                    <a href="<?php echo base_url(); ?>oman/approve_permintaan/<?php echo $p->no_permintaan; ?>/<?php echo $p->no_order; ?>" class="btn btn-xs bg-green">Approve</a>
                                                <?php }else if($p->status=='1'){ ?>
                                                    <a href="<?php echo base_url(); ?>oman/cancel_permintaan/<?php echo $p->no_permintaan; ?>/<?php echo $p->no_order; ?>" class="btn btn-xs bg-red">Batalkan</a>
                                                <?php }?>
                                            </td>
                                        </tr>
                                    <?php 
