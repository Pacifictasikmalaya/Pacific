            ...
            <div class="card">
                <div class="header bg-cyan">
                    <h2>
                        ...
                        <small>Input Order Managemen Marketing</small>
                    </h2>
                </div>
                                    ...
                                    <div class="form-line">
                                        <select class="form-control" id="bulan" name="bulan" data-error=".errorTxt9">
                                            ...
                                            <?php 
                                             ...
                                             for($i=1; $i<=12; $i++){
                                             ?>
                                                <option <?php if($i==$bulansekarang){echo "selected";} ?> value="<?php echo $i; ?>"><?php echo $bulan[$i]; ?></option>
                                             <?php
                                             }
                                    ...
                                    <div class="form-line">
                                        <select class="form-control" id="tahun" name="tahun" data-error=".errorTxt9">
                                            ...
                                            <?php 
                                             ...
                                             ?>
                                                <option <?php if($tahun==$tahunsekarang){echo "selected";} ?>  value="<?php echo $tahun; ?>"><?php echo $tahun ?></option>
                                             <?php
                                             }
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            <th style="width:60px">
                                                 <div class="form-group">
                                                    <div class="form-line">
                                                         <input type="text" id="darim1" maxlength="2"  name="darim1" class="form-control"  data-error=".errorTxt4"  />
                                                    </div>
                                                 </div>
                                            </th>
                                            <th style="width:10px;vertical-align: middle;">
                                             ...
                                             <th style="width:60px">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                         <input type="text" id="sampaim1" maxlength="2"  name="sampaim1" class="form-control"  data-error=".errorTxt4"  />
                                                    </div>
                                                </div> 
                                            </th>
                                            ...
                                            <th style="width:60px">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-line">
                                                         <input type="text" id="darim2" maxlength="2"  name="darim2" class="form-control"  data-error=".errorTxt4"  />
                                                    </div>
                                                </div>
                                            ...
                                            <th style="width:10px;vertical-align: middle;">
                                             ...
                                             <th style="width:60px">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                         <input type="text" id="sampaim2" maxlength="2"  name="sampaim2" class="form-control"  data-error=".errorTxt4"  />
                                                    </div>
                                                </div>
                                            </th>
                                            ...
                                            <th style="width:60px">
                                                 <div class="form-group">
                                                    <div class="form-line">
                                                         <input type="text" id="darim3" maxlength="2"  name="darim3" class="form-control"  data-error=".errorTxt4"  />
                                                    </div>
                                                 </div>
                                            </th>
                                            <th style="width:10px;vertical-align: middle;">
                                             ...
                                             <th style="width:60px">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                         <input type="text" id="sampaim3" maxlength="2"  name="sampaim3" class="form-control"  data-error=".errorTxt4"  />
                                                    </div>
                                                </div> 
                                            </th>
                                            <!-- Minggu Ke 4-->
                                            <th style="width:60px">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                         <input type="text" id="darim4" maxlength="2"  name="darim4" class="form-control"  data-error=".errorTxt4"  />
                                                    </div>
                                                 </div>
                                            ...
                                            <th style="width:10px;vertical-align: middle;">
                                             ...
                                             <th style="width:60px">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                         <input type="text" id="sampaim4" maxlength="2"  name="sampaim4" class="form-control"  data-error=".errorTxt4"  />
                                                    </div>
