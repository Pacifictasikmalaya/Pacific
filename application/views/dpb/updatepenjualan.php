  ...
  <div class="col-md-8">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
           UPDATE DATA REKAP PENJUALAN DPB
          <small>Update Data Rekap Penjualan DPB</small>
        </h2>
      </div>
      <div class="body">
        <div class="row">
          <div class="col-md-12">
            <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>dpb/update_penjualan">
              ...
              <div class="input-group demo-masked-input"  >
                ...
                <div class="form-line">
                  <input type="text" readonly value="<?php echo $mutasi['tgl_mutasi_gudang_cabang']; ?>" id="tgl_penjualan" name="tgl_penjualan" class="form-control datepicker" placeholder="Tanggal Penjualan" data-error=".errorTxt19" />
                </div>
              </div>
              <hr>
