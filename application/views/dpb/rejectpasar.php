                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a data-href="<?php echo base_url(); ?>dpb/hapusrejectpasar/<?php echo $d['no_mutasi_gudang_cabang']; ?>/<?php echo $d['kode_cabang']; ?>" class="btn btn-xs btn-danger hapus">Hapus</a>
                      </td>
                    </tr>
                    <?php
                      $sno++;
