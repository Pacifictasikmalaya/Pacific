  ...
  <div class="col-md-8">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
           INPUT DATA REKAP GANTI BARANG DPB
          <small>Input Data Rekap Ganti Barang DPB</small>
        </h2>
      </div>
      <div class="body">
        <div class="row">
          <div class="col-md-12">
            <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>dpb/input_gb">
              <div class="input-group demo-masked-input"  >
                <span class="input-group-addon">
                  <i class="material-icons">chrome_reader_mode</i>
                </span>
                <div class="form-line">
                  <input type="text" readonly value="" id="no_mutasi" name="no_mutasi" class="form-control" placeholder="No Mutasi Penjualan" data-error=".errorTxt19" />
                </div>
              </div>
              <div class="input-group demo-masked-input"  >
                <span class="input-group-addon">
              ...
              <div class="input-group demo-masked-input"  >
                ...
                <div class="form-line">
                  <input type="text" readonly value="" id="tgl_gb" name="tanggal" class="form-control datepicker" placeholder="Tanggal Ganti Barang" data-error=".errorTxt19" />
                </div>
              </div>
              <hr>
              <table class="table table-bordered table-striped">
                <thead class = "" >
                  <tr>
                    ...
                    <th colspan="6" style="text-align:center">Penjualan</th>
                  </tr>
                  <tr>
...
<script type="text/javascript">
  $(function(){
    ...
    function loadNoMutasi()
    {
      var nodpb = $("#nodpb").val();
      $.ajax({
        url     : '<?php echo base_url(); ?>dpb/getNomutasiGB',
        type    :'POST',
        data    : {nodpb:nodpb},
        cache   : false,
    ...
    $(".formValidate").submit(function(){
      var nodpb           = $("#nodpb").val();
      var tgl_gb          = $("#tgl_gb").val();
      if(nodpb == ""){
        swal("Oops!", "No DPB Harus Diisi!", "warning");
        return false;
      }else if(tgl_gb == ""){
        swal("Oops!", "Tanggal Ganti Barang Harus Diisi!", "warning");
        return false;
      }
    });
