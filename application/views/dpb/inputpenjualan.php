  ...
  <div class="col-md-8">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
           INPUT DATA REKAP PENJUALAN DPB
          <small>Input Data Rekap Penjualan DPB</small>
        </h2>
      </div>
      <div class="body">
        <div class="row">
          <div class="col-md-12">
            <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>dpb/input_penjualan">
              ...
              <div class="input-group demo-masked-input"  >
                ...
                <div class="form-line">
                  <input type="text" readonly value="" id="tgl_penjualan" name="tgl_penjualan" class="form-control datepicker" placeholder="Tanggal Penjualan" data-error=".errorTxt19" />
                </div>
              </div>
              <hr>
...
<script type="text/javascript">
  $(function(){
    ...
    function loadNoMutasi()
    {
      var nodpb = $("#nodpb").val();
      $.ajax({
        url     : '<?php echo base_url(); ?>dpb/getNomutasiPenjualan',
        type    :'POST',
        data    : {nodpb:nodpb},
        cache   : false,
    ...
    $(".formValidate").submit(function(){
      ...
      if(nodpb == ""){
        ...
        swal("Oops!", "Tanggal Penjualan Harus Diisi!", "warning");
        return false;
      }
    });
