  ...
  <div class="col-md-12">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
          DATA REKAP PENJUALAN DPB
          <small>DATA REKAP PENJUALAN DPB</small>
        </h2>
      </div>
      <div class="body">
        <div class="row">
        ...
        <div class="row clearfix">
          <div class="col-sm-12">
            <a href="<?php echo base_url();?>dpb/inputpenjualan" class="btn btn-danger">Tambah Data</a>
            <hr>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo base_url(); ?>dpb/updatepenjualan/<?php echo $d['no_mutasi_gudang_cabang']; ?>" class="btn btn-xs bg-blue">Update</a>
                        <a data-href="<?php echo base_url(); ?>dpb/hapuspenjualan/<?php echo $d['no_mutasi_gudang_cabang']; ?>/<?php echo $d['kode_cabang']; ?>" class="btn btn-xs btn-danger hapus">Hapus</a>
                      </td>
                    </tr>
                    <?php
                      $sno++;
