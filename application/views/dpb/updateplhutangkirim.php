  ...
  <div class="col-md-8">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
           UPDATE DATA REKAP PELUNASAN HUTANG KIRIM
          <small>Update Data Rekap Pelunasan Hutang Kirim DPB</small>
        </h2>
      </div>
      <div class="body">
        <div class="row">
          <div class="col-md-12">
            <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>dpb/update_plhutangkirim">
