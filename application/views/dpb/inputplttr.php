  ...
  <div class="col-md-8">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
           INPUT DATA REKAP  PELUNASAN TTR DPB
          <small>Input Data Rekap Pelunasan TTR DPB</small>
        </h2>
      </div>
      <div class="body">
        <div class="row">
          <div class="col-md-12">
            <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>dpb/input_plttr">
              <div class="input-group demo-masked-input"  >
                <span class="input-group-addon">
                  <i class="material-icons">chrome_reader_mode</i>
                </span>
                <div class="form-line">
                  <input type="text" readonly value="" id="no_mutasi" name="no_mutasi" class="form-control" placeholder="No Mutasi Pelunasan TTR" data-error=".errorTxt19" />
                </div>
              </div>
              <div class="input-group demo-masked-input"  >
                <span class="input-group-addon">
              ...
              <div class="input-group demo-masked-input"  >
                ...
                <div class="form-line">
                  <input type="text" readonly value="" id="tgl_gb" name="tanggal" class="form-control datepicker" placeholder="Tanggal Pelunasan TTR" data-error=".errorTxt19" />
                </div>
              </div>
              <hr>
...
<script type="text/javascript">
  $(function(){
    ...
    function loadNoMutasi()
    {
      var nodpb = $("#nodpb").val();
      $.ajax({
        url     : '<?php echo base_url(); ?>dpb/getNomutasiplTTR',
        type    :'POST',
        data    : {nodpb:nodpb},
        cache   : false,
    ...
    $(".formValidate").submit(function(){
      ...
      if(nodpb == ""){
        ...
        swal("Oops!", "Tanggal Pelunasan TTR Diisi!", "warning");
        return false;
      }
    });
