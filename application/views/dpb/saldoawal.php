    ...
    <div class="card">
      <div class="header bg-cyan">
        <h2>
          ...
          <small>DATA SALDO AWAL <?php echo $status; ?></small>
        </h2>
      </div>
      <div class="body">
        <div class="row">
        ...
        <div class="row clearfix">
          <div class="col-sm-12">
            ...
            ?>
            <a href="<?php echo base_url();?>dpb/<?php echo $link; ?>" class="btn btn-danger">Tambah Data</a>
            <hr>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><span class="badge <?php if($d['status']=='GS'){echo 'bg-green';}else{echo 'bg-red';} ?>"><?php echo $d['status']; ?></span></td>
                      <td>
                        <a href="#" class="btn btn-xs btn-info detail" data-kodesaldoawal="<?php echo $d['kode_saldoawal']; ?>">Detail</a>
                        <a data-href="<?php echo base_url(); ?>dpb/hapussaldoawal/<?php echo $d['kode_saldoawal']; ?>/<?php echo $d['status']; ?>" class="btn btn-xs btn-danger hapus">Hapus</a>
                      </td>
                    </tr>
                    <?php
                      $sno++;
