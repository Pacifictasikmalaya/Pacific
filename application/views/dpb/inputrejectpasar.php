    ...
    <div class="card">
      <div class="header bg-cyan">
        <h2>
          ...
          <small>Input Data Rekap Reject Pasar DPB</small>
        </h2>
      </div>
      <div class="body">
        <div class="row">
          <div class="col-md-12">
            <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>dpb/input_rejectpasar">
              ...
              <div class="input-group demo-masked-input"  >
                ...
                <div class="form-line">
                  <input type="text" readonly value="" id="tgl_gb" name="tanggal" class="form-control datepicker" placeholder="Tanggal Reject Pasar" data-error=".errorTxt19" />
                </div>
              </div>
              <hr>
...
<script type="text/javascript">
  $(function(){
    ...
    function loadNoMutasi()
    {
      var nodpb = $("#nodpb").val();
      $.ajax({
        url     : '<?php echo base_url(); ?>dpb/getNomutasiRJP',
        type    :'POST',
        data    : {nodpb:nodpb},
        cache   : false,
