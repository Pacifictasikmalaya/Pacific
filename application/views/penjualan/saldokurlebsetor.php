  ...
  <div class="col-md-12">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
          DATA SALDO AWAL KURANG LEBIH SETOR
          <small>DATA SALDO AWAL KURANG LEBIH SETOR </small>
        </h2>
      </div>
      <div class="body">
        <div class="row">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a data-href="<?php echo base_url(); ?>penjualan/hapussaldoawalkurleb/<?php echo $d['kode_saldokurleb']; ?>" class="btn btn-xs btn-danger hapus">Hapus</a>
                        <a data-href="#"  class="btn btn-xs btn-primary detail" data-id="<?php echo $d['kode_saldokurleb'] ?>">Detail</a>
                      </td>
                    </tr>
                    <?php
                      $sno++;
    ...
    <div class="modal-content">
      <div class="card">
        <div class="header bg-cyan">
          <h2>
            DETAIL
            <small>Detail Saldo Awal Kurang Lebih Setor</small>
          </h2>
        </div>
        <div class="body">
          <div class="row clearfix">
...
<script type="text/javascript">
  $(function(){
    $('#setsaldo').click(function(e){
     ...
     $("#loadsaldoawal").load('<?php echo base_url(); ?>penjualan/inputsaldoawalkurleb');
   });
   ...
   $(".detail").click(function(e){
     ...
     $("#loaddetailsaldoawal").load('<?php echo base_url(); ?>penjualan/getdetailsaldosaleskurleb/'+id);
   })
