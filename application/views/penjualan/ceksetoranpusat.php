              ...
              <div class="col-md-12">
                <form method="POST" autocomplete="off">
                  ...
                  <div class="form-group">
                    <div class="form-line">
                      <select class="form-control show-tick" id="cabang" name="cabang" data-error=".errorTxt1">
                        ...
                        <option <?php if($cbg==$c->kode_cabang){echo "selected";} ?>
                  ...
                  <div class="form-group">
                    <div class="col-md-6">
                      <div class="form-line">
                        <input type="text" value="<?php echo $dari; ?>" id="dari" name="dari"
                          class="form-control datepicker date" placeholder="Dari" data-error=".errorTxt11">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-line">
                        <input type="text" value="<?php echo $sampai; ?>" id="sampai" name="sampai"
                          class="form-control datepicker date" placeholder="Sampai" data-error=".errorTxt11">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                ...
                <table class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="right">
                        <b><?php if($d['uang_kertas']!=0){echo number_format($d['uang_kertas'],'0','','.');} ?></b></td>
                      <td align="right">
                        <b><?php if($d['uang_logam']!=0){echo number_format($d['uang_logam'],'0','','.');} ?></b></td>
                      <td align="right">
                        <b><?php if($d['transfer']!=0){echo number_format($d['transfer'],'0','','.');} ?></b></td>
                      <td align="right"><b><?php if($d['giro']!=0){echo number_format($d['giro'],'0','','.');} ?></b>
                      </td>
                      <td align="right">
                        <b><?php if($jumlahsetoran!=0){echo number_format($jumlahsetoran,'0','','.');} ?></b></td>
                      <td>
                        <?php
                          if($d['status']==0){
                      ...
                      <td>
                        <?php if(empty($d['no_ref'])){
                          if($d['status']==0){
                        ?>
                        <a href="#" data-id="<?php echo $d['kode_setoranpusat'] ?>"
                          class="btn bg-green btn-xs terimasetoran"><i class="material-icons">check</i></a>
                        <?php
                          }else{
                        ?>
                        <a href="<?php echo base_url(); ?>penjualan/batalterimasetoran/<?php echo $d['kode_setoranpusat']; ?>"
                          class="btn bg-red btn-xs"><i class="material-icons">cancel</i></a>
                        <?php
                          }
                        } 
                        ?>
