        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
              <form class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporanpenjualan/cetak_aup" target="_blank">
                  <?php if ($cb == 'pusat') { ?>
                    <div class="mb-3">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="input-icon">
                          <input id="tanggal" type="date" placeholder="Lihat Pertanggal" class="form-control" name="tanggal" />
