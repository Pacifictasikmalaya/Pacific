    ...
    <div class="col-md-6">
        <div class="card">
            <div class="header bg-cyan">
                <h2>
                    Laporan Penjualan - Kas Besar
                    <small>Laporan Penjualan - Kas Besar </small>
                </h2>
            </div>
            <div class="body">
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <form class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporanpenjualan/cetak_penjualankasbesar" target="_blank">
                            <label>Cabang</label>
