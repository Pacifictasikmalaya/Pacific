    ...
    <div class="col-md-6">
        <div class="card">
            <div class="header bg-cyan">
                <h2>
                    REKAP UANG LOGAM
                    <small>REKAP UANG LOGAM</small>
                </h2>
            </div>
            <div class="body">
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <form class="formValidate FormBJ" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporanpenjualan/cetak_uanglogam" target="_blank">
                            <label>Cabang</label>
