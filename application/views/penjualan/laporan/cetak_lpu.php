  ...
  <tbody>
    <tr style="font-size:12px">
      ...
      <?php
        ...
        ?>
        <td style="text-align:right; color:red; font-weight:bold"><?php if(!empty($setoranbulanlast['jumlah'])){echo uang($setoranbulanlast['jumlah']);} ?></td>
        <?php
          }
      ?>
      <td style="text-align:right; color:red; font-weight:bold"><?php if(!empty($totalsetoranbulanlast)){echo uang($totalsetoranbulanlast);} ?></td>
    </tr>
    <?php
    ...
    <tr style="font-size:12px">
      ...
      ?>
      <td style="text-align:right; font-weight:bold"><?php if(!empty($setoran['totallhp'])){echo uang($setoran['totallhp']);} ?></td>
      <?php
        }
      ?>
      <td style="text-align:right; font-weight:bold"><?php if(!empty($totalsetoran)){echo uang($totalsetoran);} ?></td>
      <td style="border:none; width:5%"></td>
      <td><?php echo DateToIndo2($dari); ?></td>
      <?php
        $totalsetoranpusat = 0;
        foreach($listbank as $b){
          $qsetoranpusat     = "SELECT SUM(uang_kertas+uang_logam+giro+IFNULL(transfer,0)) as totalsetoranpusat FROM setoran_pusat WHERE tgl_diterimapusat='$dari' AND bank='$b->kode_bank' AND kode_cabang='$cbg' AND status='1'  GROUP BY tgl_diterimapusat,bank";
          $setoranpusat      = $this->db->query($qsetoranpusat)->row_array();
          $totalsetoranpusat = $totalsetoranpusat + $setoranpusat['totalsetoranpusat'];
      ?>
      <td style="text-align:right; font-weight:bold"><?php if(!empty($setoranpusat['totalsetoranpusat'])){echo uang($setoranpusat['totalsetoranpusat']);} ?></td>
      <?php
        }
      ?>
      <td style="text-align:right; font-weight:bold"><?php if(!empty($totalsetoranpusat)){echo uang($totalsetoranpusat);} ?></td>
    </tr>
    <?php
  ...
  <tfoot>
    <tr style="font-size:12px; background-color:#199291; color:white" >
      ...
      <?php
        ...
        $totalallsetoran = $totalallsetoran+$setoranbulanlast['jumlah'] + $allsetoran['totallhp'];
      ?>
      <td style="text-align:right; font-weight:bold"><?php if(!empty($allsetoran['totallhp'])){echo uang($allsetoran['totallhp']);} ?></td>
      <?php
        }
      ?>
      <td style="text-align:right; font-weight:bold"><?php if(!empty($totalallsetoran+$totalsetoranbulanlast)){echo uang($totalallsetoran+$totalsetoranbulanlast);} ?></td>
      <td style="border:none; width:5%; background-color:white"></td>
      <td><b>TOTAL</b></td>
      <?php
        $totalallsetoranpusat = 0;
        foreach($listbank as $b){
        $qallsetoranpusat     = "SELECT SUM(uang_kertas+uang_logam+giro +IFNULL(transfer,0)) as totalsetoranpusat FROM setoran_pusat WHERE tgl_setoranpusat BETWEEN '$from' AND '$sampai' AND bank='$b->kode_bank' AND kode_cabang='$cbg' AND status ='1' GROUP BY bank";
      ...
      ?>
      <td style="text-align:right; font-weight:bold"><?php if(!empty($allsetoranpusat['totalsetoranpusat'])){echo uang($allsetoranpusat['totalsetoranpusat']);} ?></td>
      <?php
        }
      ?>
      <td style="text-align:right; font-weight:bold"><?php if(!empty($totalallsetoranpusat)){echo uang($totalallsetoranpusat);} ?></td>
    </tr>
    <tr style="font-size:12px; background-color:#199291; color:white" >
      <?php
        $namaBulanlast  = array("","Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember");
      ...
      ?>
      	<td style="text-align:right; font-weight:bold"><?php if(!empty($gmlast['jumlah'])){echo uang($gmlast['jumlah']);} ?></td>
        <?php
          }
        ?>
      	<td style="text-align:right; font-weight:bold"><?php if(!empty($totalgmlast)){echo uang($totalgmlast);} ?></td>
    </tr>
    <tr style="font-size:12px; background-color:#199291; color:white" >
    <?php
    ...
    <td><b>GM <?php echo strtoupper($namaBulanskrg[$bulanskrg])." ".$tahunskrg; ?></b></td>
	    ...
	    ?>
      <td style="text-align:right; font-weight:bold;"><?php if(!empty($gmnow['jumlah'])){echo uang($gmnow['jumlah']);} ?></td>
      <?php
        }
      ?>
      <td style="text-align:right; font-weight:bold;"><?php if(!empty($totalgmnow)){echo uang($totalgmnow);} ?></td>
    </tr>
    <tr style="font-size:12px; background-color:#199291; color:white" >
      ...
      ?>
      <td style="text-align:right; font-weight:bold; "><?php if(!empty($tr['jumlah'])){echo uang($tr['jumlah']);} ?></td>
      <?php
        }
      ?>
      <td style="text-align:right; font-weight:bold;"><?php if(!empty($totaltr)){echo uang($totaltr);} ?></td>
    </tr>
    <tr style="font-size:12px; background-color:#199291; color:white" >
      <td><b>TOTAL</b></td>
      <?php
        ...
        WHERE
          ...
          $grandall   = ($allsetoran['totallhp'] + $gmlast['jumlah'])-$gmnow['jumlah']-$tr['jumlah'];
          $grandtotal = $grandtotal + $grandall;
        ?>
        <td style="text-align:right; font-weight:bold;"><?php if(!empty($grandall)){echo uang($grandall);} ?></td>
        <?php
          }
        ?>
      <td style="text-align:right; font-weight:bold;"><?php if(!empty($grandtotal+$totalsetoranbulanlast)){echo uang($grandtotal+$totalsetoranbulanlast);} ?></td>
    </tr>
  </tfoot>
</table>
<br>
...
<table class="datatable3" style="font-size:16px">
  <tr>
    ...
    <td style="text-align:right; font-weight:bold;"><?php echo uang($grandtotal+$totalsetoranbulanlast); ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="text-align:right; font-weight:bold;"><?php echo uang(($grandtotal+$totalsetoranbulanlast)-$totalallsetoranpusat); ?></td>
  </tr>
</table>
