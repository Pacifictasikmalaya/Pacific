  ...
  <div class="col-md-6">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
          INPUT BUKTI PENYERAHAN HASIL PRODUKSI (BPBJ)
          <small>Input BPBJ</small>
        </h2>
      </div>
      <div class="body">
        <div class="row clearfix">
          <form name="autoSumForm" autocomplete="off"   method="POST" action="<?php echo base_url(); ?>bpbj/input_bpbj">
            <div class="row">
              <div class="body">
                <div class="col-md-12">
                  ...
                  <div class="input-group demo-masked-input"  >
                    ...
                    <div class="form-line">
                      <input type="text" value=""  id="tgl_bpbj" name="tgl_bpbj" class="datepicker form-control date" placeholder="Tanggal" data-error=".errorTxt19" />
                    </div>
    ...
    <div class="card">
      <div class="header bg-cyan">
          <h2>
            DATA BUKTI PENYERAHAN HASIL PRODUKSI (BPBJ)
            <small>Data BPBJ</small>
          </h2>
      </div>
      <div class="body">
      <div class="row">
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="#" data-target="#konfirmasi_hapus" data-toggle="modal" data-href="<?php echo base_url(); ?>bpbj/hapus/<?php echo $d['no_mutasi_produksi']; ?>/<?php echo $this->uri->segment(3); ?>" class="btn bg-red btn-xs"><i class="material-icons">delete</i></a>
                    </td>
                  </tr>
                <?php
                    $sno++;
    ...
    $("#tambahbarang").click(function(e){
        ...
        if(tgl_bpbj==""){
          ...
          $.ajax({
            ...
            data    : {kode_produk:kode_produk,shift:shift,jumlah:jumlah,tgl_bpbj:tgl_bpbj},
            cache   : false,
            success : function(respond){
              console.log(respond);
              if(respond == 1){
