...
?>
	<tr>
		...
		<td>
			<a href="#"  data-id="<?php echo $b->kode_produk; ?>" data-shift="<?php echo $b->shift; ?>" class="btn bg-red btn-xs hapus"><i class="material-icons">delete</i></a>
		</td>
	</tr>
	...
	$(function(){
		...
		$(".hapus").click(function(e){
			...
			$.ajax({
				...
				data 		: {kode_produk:id,shift:shift},
				cache		: false,
