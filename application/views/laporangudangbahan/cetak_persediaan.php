...
<b style="font-size:20px; font-family:Calibri">
  PACIFIC<br>
  REKAPITULASI PERSEDIAAN GUDANG <?php if ($kategori == 'K009') {
    echo "BAHAN";
  }else{
    echo "KEMASAN";
  } ?><br>
...
<table class="datatable3" style="width:100%" border="1">
  <thead>
    ...
    <tr bgcolor="#024a75">
      ...
      <th colspan="5" style="color:white; font-size:14;">PENGELUARAN</th>
  ...
  <tbody>
    ...
    foreach ($data as $key => $d) {
      $saldoakhirberat     = $d->qtyberatsa + $d->qtypemb2 + $d->qtylainnya2 - $d->qtyprod4 -$d->qtyseas4 - $d->qtypdqc4 - $d->qtylain4 - $d->qtysus4;
      $saldoakhirunit      = $d->qtyunitsa + $d->qtypemb1 + $d->qtylainnya1 - $d->qtyprod3 -$d->qtyseas3 - $d->qtypdqc3 - $d->qtylain3 - $d->qtysus3;
