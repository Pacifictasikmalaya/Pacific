...
<table class="datatable3" style="width:100%" border="1" style="font-size: 14">
  ...
  <tfoot bgcolor="#024a75" style="color:white; font-size:14;">
    <tr>
     ...
     <th style="color:white; font-size:14;"><?php echo uang($qty_unit);?></th>
     <th style="color:white; font-size:14;"><?php echo uang($qty_berat,2);?></th>
     <th style="color:white; font-size:14;"><?php echo uang($qty_lebih,2);?></th>
   </tr>
 </tfoot>
</table>
