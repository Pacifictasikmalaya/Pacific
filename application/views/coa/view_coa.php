	...
	<div class="col-md-12">
        <div class="card">
            <div class="header bg-cyan">
                <h2>
                    Chart Of Accounts
                    <small>List Data Chart of Accounts</small>
                </h2>
            </div>
            <div class="body">
                <div class="row clearfix">
                    <div class="col-sm-12">
                        <a href="#" class="btn bg-red waves-effect" id="tambahcoa"> Tambah Data </a>
												<hr>
																	...
																	?>
																		<tr>
																						...
																						?>
																							<tr>
																											...
																											?>
																												<tr>
																															...
																															<table class="table ">
																																...
																																?>
																																	<tr>
																																		...
																																		<td>
																																			<a href="#" class="btn btn-xs bg-red" data-target="#konfirmasi_hapus" data-toggle="modal" data-href="<?php echo base_url(); ?>coa/hapus/<?php echo $shh->kode_akun; ?>"><i class="material-icons">delete</i></a>
																																		</td>
																																	</tr>
																																<?php } ?>
																															</table>
																													...
																													<td>
																														...
																														<a href="#" class="btn btn-xs bg-red" data-target="#konfirmasi_hapus" data-toggle="modal" data-href="<?php echo base_url(); ?>coa/hapus/<?php echo $sh->kode_akun; ?>"><i class="material-icons">delete</i></a>
																													</td>
																												</tr>
																											<?php } ?>
																										</table>
																								...
																								<td>
																									...
																									<a href="#" class="btn btn-xs bg-red" data-target="#konfirmasi_hapus" data-toggle="modal" data-href="<?php echo base_url(); ?>coa/hapus/<?php echo $s->kode_akun; ?>"><i class="material-icons">delete</i></a>
																								</td>
																							</tr>
																						<?php } ?>
																					</table>
																			...
																			<td>
																				...
																				<a href="#" class="btn btn-xs bg-red" data-target="#konfirmasi_hapus" data-toggle="modal" data-href="<?php echo base_url(); ?>coa/hapus/<?php echo $r->kode_akun; ?>"><i class="material-icons">delete</i></a>
																			</td>
																		</tr>
																<?php } ?>
																</tbody>
