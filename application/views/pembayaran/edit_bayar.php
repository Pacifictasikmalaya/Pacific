<form autocomplete="off" class="bayarForm" id="formValidate" method="POST" action="<?php echo base_url(); ?>pembayaran/editbayar">
  ...
  <div class="row mb-3">
    <div class="col-md-12">
      <label class="form-check form-switch">
        ...
        ?>
        <input class="form-check-input <?php echo $checked; ?> girotocash" type="checkbox" name="girotocash" value="1">
