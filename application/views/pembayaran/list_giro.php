                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <?php if ($d['ket'] == "") { ?>
                              <a href="#" data-id="<?php echo $d['no_giro']; ?>" data-status="<?php echo $d['status']; ?>" class="btn bg-green btn-xs editgiro"><i class="material-icons">mode_edit</i></a>
                              <a href="#" data-id="<?php echo $d['no_giro']; ?>" class="btn bg-blue btn-xs detail"><i class="material-icons">remove_red_eye</i></a>
                            <?php } ?>
                          </td>
                        </tr>
                      <?php $sno++;
...
<div class="modal fade" id="detailgiro" tabindex="-1" role="dialog">
...
<script type="text/javascript">
  $(function() {
    ...
    $("form").submit(function() {
      ...
      if (dari != "" && sampai == "") {
        swal("Oops!", "Periode Sampai Harus Diisi !", "warning");
        return false;
      } else if (dari == "" && sampai != "") {
        swal("Oops!", "Periode Dari Harus Diisi !", "warning");
        return false;
      }
    });
