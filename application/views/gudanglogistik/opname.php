  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="body">
        ...
        <div class="row clearfix">
          <div class="col-sm-12">
            <a href="<?php echo base_url(); ?>gudanglogistik/inputopname" class="btn btn-danger">Tambah Data</a>
            <hr>
                ...
                <tbody>
                  ...
                  foreach ($result as $d){
                    ...
                    <tr>
                      ...
                      <td width="10px">
                        <a href="#" data-kode_opname_gl="<?php echo $d['kode_opname_gl']; ?>" class="btn btn-xs btn-primary detail">Detail</a>
                        <a href="<?php echo base_url(); ?>gudanglogistik/inputdetailopname/<?php echo $kode_opname_gl; ?>" class="btn btn-xs btn-success">Input</a>
                        <a href="#" data-href="<?php echo base_url(); ?>gudanglogistik/hapusopname/<?php echo $kode_opname_gl; ?>" class="btn btn-xs btn-danger hapus">Hapus</a>
                      </td>
                    </tr>
                    <?php
                    $no++;
