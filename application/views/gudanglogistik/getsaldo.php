...
foreach ($detail as $b) {
  ...
  <tr>
    ...
    <td>
      <a data-kode="<?php echo $b->kode_saldoawal_gl;?>" data-id="<?php echo $b->kode_barang;?>" class="btn btn-xs btn-danger hapus">Hapus</a>
      <a data-kode="<?php echo $b->kode_saldoawal_gl;?>" data-id="<?php echo $b->kode_barang;?>" data-nama="<?php echo $b->nama_barang;?>" data-qty="<?php echo $b->qtysaldoawal;?>" data-harga="<?php echo $b->harga;?>" class="btn btn-xs btn-warning edit">Edit</a>
    </td>
  </tr>
  <?php
  $no++;
