  ...
  <tbody>
    ...
    foreach ($data as $key => $d) {
      ...
      <tr style="font-size: 14">
        ...
        <td align="center"><?php if ($d->saldoawal != "0" AND $d->saldoawal != "") { echo number_format($d->saldoawal,2); };?></td>
        <td align="center"><?php if ($d->gudang != "0" AND $d->gudang != "") { echo number_format($d->gudang,2); };?></td>
        <td align="center"><?php if ($d->seasoning != "0" AND $d->seasoning != "") { echo number_format($d->seasoning,2); };?></td>
        <td align="center"><?php if ($d->trial != "0" AND $d->trial != "") { echo number_format($d->trial,2); };?></td>
        <td align="center"><?php if ($d->pemakaian != "0" AND $d->pemakaian != "") { echo number_format($d->pemakaian,2); };?></td>
        <td align="center"><?php if ($d->retur != "0" AND $d->retur != "") { echo number_format($d->retur,2); };?></td>
        <td align="center"><?php if ($d->lainnya != "0" AND $d->lainnya != "") { echo number_format($d->lainnya,2); };?></td>
        <td align="center"><?php if ($saldoakhir != "0" AND $saldoakhir != "") { echo number_format($saldoakhir,2); };?></td>
        <td align="center"><?php if ($d->opname != "0" AND $d->opname != "") { echo number_format($d->opname,2); };?></td>
        <td align="center"><?php if ($saldoakhir - $d->opname != "0") { echo number_format($saldoakhir - $d->opname,2); };?></td>
      </tr>
      <?php 
    } 
    ?>
