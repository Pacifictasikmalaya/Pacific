...
<table class="garis6" style="width:100%">
  ...
  <?php $no = 1; $total=0; foreach($detail as $d){  $total = $total + $d->jmlbayar;?>
    <tr style="text-align:center">
      ...
      <td style="text-align:right"><?php echo number_format($d->jmlbayar,'0','','.'); ?></td>
    </tr>
  <?php $no++; } ?>
  <tr>
...
<table style="width:100%" border="0">
  <tr style="font-family:Tahoma; font-size:16px; font-weight:bold">
    <td style="width:6%">TERBILANG :</td>
