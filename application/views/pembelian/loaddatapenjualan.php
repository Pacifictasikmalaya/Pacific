...
foreach($pnj as $d){
  ...
  <tr>
    ...
    <td align="right"><a href="#" data-nobukti="<?php echo $d->nobukti_pembelian; ?>" data-kodebarang="<?php echo $d->kode_barang; ?>" class="btn bg-red btn-xs hapus"><i class="material-icons">delete</i></a></td>
  </tr>
<?php $no++;} ?>
<tr>
    ...
    $(".hapus").click(function(e){
      ...
      var kodebarang  = $(this).attr("data-kodebarang");
			...
			$.ajax({
				...
				data 		: {nobukti:nobukti,kodebarang:kodebarang},
				cache		: false,
				success : function(respond){
          loaddatapenjualan();
				}
