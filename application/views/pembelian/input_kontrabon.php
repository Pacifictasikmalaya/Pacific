...
<div class="card">
  <div class="header bg-cyan">
    <h2>
      ...
      <small>Input Data Kontra BON / Internal Memo</small>
    </h2>
  </div>
  <div class="body">
    <form autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>pembelian/insert_kontrabon">
      <div class="row clearfix">
        <div class="col-sm-6">
          ...
          <div class="form-group" >
            <div class="form-line">
              <select class="form-control show-tick" id="jenisbayar" name="jenisbayar" data-error=".errorTxt1">
...
<!---MODAL DATA BARANG-->
<div class="modal fade" id="datapembelian" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="card">
			  <div class="header bg-cyan">
			    <h2>
			      Data Pembelian
			     	<small>Pilih Data Pembelian</small>
			    </h2>
			  </div>
		    <div class="body">
		      <div class="row clearfix">
		        <div class="col-sm-12" id="tabelpembelian">
		        </div>
		      </div>
		    </div>
			</div>
  ...
  $(function(){
    ...
    function loadNoKB()
    {
      ...
      $.ajax({
        ...
        data     : {tgl_kontrabon:tgl_kontrabon,status:status},
        cache    : false,
        success  : function(respond){
    ...
    $("#tambahbarang").click(function(e){
      ...
      if(nobukti ==""){
        ...
        $.ajax({
          ...
          data      : {nobukti:nobukti,keterangan:keterangan,jmlbayar:jmlbayar,supplier:supplier},
          cache     : false,
          success   : function(respond){
            if(respond == 1){
