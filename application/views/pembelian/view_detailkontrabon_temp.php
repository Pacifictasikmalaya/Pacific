...
foreach($kb as $d){
  ...
  <tr>
    ...
    <td align="right"><a href="#" data-nobukti="<?php echo $d->nobukti_pembelian; ?>"  data-idadmin="<?php echo $d->id_admin; ?>" class="btn bg-red btn-xs hapus"><i class="material-icons">delete</i></a></td>
  </tr>
<?php $no++;} ?>
<tr>
    ...
    $(".hapus").click(function(e){
      var nobukti       = $(this).attr("data-nobukti");
			...
			$.ajax({
				...
				data 		: {nobukti:nobukti,idadmin:id_admin},
				cache		: false,
