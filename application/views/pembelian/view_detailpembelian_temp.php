...
foreach($pmb as $d){
  ...
  <tr>
    ...
    <td align="right"><a href="#"  data-kodebarang="<?php echo $d->id; ?>" data-idadmin="<?php echo $d->id_admin; ?>" class="btn bg-red btn-xs hapus"><i class="material-icons">delete</i></a></td>
  </tr>
<?php $no++;} ?>
<tr>
