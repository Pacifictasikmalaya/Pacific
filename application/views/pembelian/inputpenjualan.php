    ...
    <div class="body">
      ...
      <div class="col-md-12">
        ...
        <div class="form-group" >
          <div class="form-line">
            <select class="form-control show-tick" id="akunpenj" name="akunpenj" data-live-search="true" data-error=".errorTxt1">
        ...
        <div class="row clearfix">
          <div class="col-md-offset-10">
            <a href="#" id="addpenjualan" class="btn btn-sm bg-blue  waves-effect">Tambah</a>
          </div>
        </div>
      </div>
    </div>
    ...
    $("#addpenjualan").click(function(e){
      ...
      if(keterangan == "")
      {
        ...
        $.ajax({
          ...
          data  : {nobukti:nobukti,keterangan:keterangan,qty:qty,harga:harga,akunpenj:akunpenj,jenistransaksi:jenistransaksi},
          cache : false,
          success : function (respond){
            loaddatapenjualan();
            console.log(respond);
