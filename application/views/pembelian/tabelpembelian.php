  ...
  <tbody>
    <?php $no = 1; foreach ($pmb as $p): ?>
      <tr>
        ...
        <td>
          <a href="#" data-kode="<?php echo $p->nobukti_pembelian ?>" data-total ="<?php echo number_format($p->harga,'2',',','.'); ?>" class="btn btn-xs btn-danger pilih">Pilih</a>
        </td>
      </tr>
    <?php $no++; endforeach; ?>
  </tbody>
