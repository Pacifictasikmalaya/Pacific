...
<table class="table table-bordered table-hover table-striped">
  ...
  <tbody>
    <?php $no = 1; $total = 0; foreach($detail as $d){  $total = $total + (($d->qty * $d->harga) + $d->penyesuaian); ?>
      <tr>
        <td><?php echo $no; ?></td>
...
?>
  <table class="table table-bordered table-striped">
    ...
    <tbody>
      <?php $totalharga = 0; $no=1; foreach($pmbpnj as $d){ $totalharga = $totalharga + ($d->qty * $d->harga); ?>
        <tr>
          <td><?php echo $no; ?></td>
   ...
   <tbody>
     ...
     ?>
       <tr>
         ...
         <td>
           <?php
            if($k->kategori=='TN'){echo "TUNAI";}else{echo $k->kategori;};
           ?>
         </td>
         <td>
           <?php
