...
class Oman extends CI_Controller{
	...
	function edit_oman(){
		if(isset($_POST['submit'])){
			...
			$data['oman']		= $this->Model_oman->view_oman($no_order)->row_array();
			$data['produk'] 	= $this->Model_oman->listproduk()->result();
	...
	function input_permintaan(){
		if(isset($_POST['submit'])){
			...
			$oman										= $this->Model_oman->view_oman($data['no_order'])->row_array();
			$data['oman']						= $oman;
	...
	function detail_permintaan(){
		$no_order 					= $this->input->post('no_order');
		$oman								= $this->Model_oman->view_oman($no_order)->row_array();
		$data['oman']				= $oman;
	...
	function permintaan_produksi(){
		$data['permintaan'] = $this->Model_oman->view_permintaanproduksi()->result();
