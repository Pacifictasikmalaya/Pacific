...
class Kaskecil extends CI_Controller{
  ...
  function hapus_kaskkecil(){
    ...
    $this->Model_kaskecil->hapus_kaskkecil($id);
  }
  ...
  function klaim($rowno=0){
    ...
    $sampai 		= "";
	    ...
	    // All records count
	    $allcount 	  = $this->Model_kaskecil->getrecordKlaim($dari,$sampai);
	    // Get records
	    $users_record = $this->Model_kaskecil->getDataKlaim($rowno,$rowperpage,$dari,$sampai);
  ...
  function klaimcabang($rowno=0){
    ...
    if($this->input->post('submit') != NULL ){
      ...
      if($this->session->userdata('cbg') != NULL){
	    ...
	    // All records count
	    $allcount 	  = $this->Model_kaskecil->getrecordKlaimcabang($dari,$sampai,$cbg);
	    // Get records
	    $users_record = $this->Model_kaskecil->getDataKlaimcabang($rowno,$rowperpage,$dari,$sampai,$cbg);
  ...
  function mutasibank($rowno=0){
    ...
    $sampai 		= "";
	    ...
	    // All records count
	    $allcount 	  = $this->Model_kaskecil->getrecordMBCount($dari,$sampai);
	    // Get records
	    $users_record = $this->Model_kaskecil->getDataMB($rowno,$rowperpage,$dari,$sampai);
      ...
      $data['saldoawal']         = $this->Model_kaskecil->getSaldoAwalMB($dari,$sampai)->row_array();
      $data['ceksaldoawal']      = $this->Model_kaskecil->cekSaldoAwalMB()->num_rows();
      // Load view
      ...
      $this->session->set_flashdata('msg',
          ...
          '<div class="alert bg-red alert-dismissible" role="alert">
                ...
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                   ...
                   <i class="material-icons" style="float:left; margin-right:10px">check</i> Laporan Suda Di Tutu Untuk Bulan Tersebut !
